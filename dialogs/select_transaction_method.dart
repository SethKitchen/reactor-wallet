...
import 'package:sethkitchen/wallet/dialogs/transaction_not_supported.dart';
import 'package:sethkitchen/wallet/pages/scan_qr.dart';
  ...
  void solanaPaySelected() async {
    ...
    if (result != null) {
      ...
      if (uriSolanaPay != null) {
        try {
          TransactionSolanaPay txData =
              TransactionSolanaPay.parseUri(uriSolanaPay);
          ...
          if (txData.splToken != null) {
            try {
              Token selectedToken =
                  walletAccount.getTokenByMint(txData.splToken!);
